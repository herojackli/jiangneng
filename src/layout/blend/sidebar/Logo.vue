  ...
  <div class="sidebar-logo-container" :class="{'collapse':collapse}">
    <transition name="sidebarLogoFade">
      <router-link v-if="collapse" key="collapse" class="sidebar-logo-link" to="/">
        ...
        <img src="@/assets/images/hongan4d.png" class="sidebar-logo" v-else />
      </router-link>
      <router-link v-else key="expand" class="sidebar-logo-link" to="/">
        <img :src="define.comUrl+sysConfig.navigationIcon" class="sidebar-logo"
          v-if="sysConfig && sysConfig.navigationIcon" />
        <template v-else>
          <img src="@/assets/images/hongan4d2.png" class="sidebar-logo"
            v-if="slideClass==='lightWhite'" />
          <img src="@/assets/images/hongan4d1.png" class="sidebar-logo" v-else />
        </template>
      </router-link>
    </transition>
  </div>
