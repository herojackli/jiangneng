  ...
  <div class="im-container" v-if="visible">
    ...
    <div class="main">
      ...
      <div class="historyBox" v-if="showHistory">
        <el-input v-model="keyword" placeholder="搜索：请输入关键词" class="HONGAN4D-common-head-input" clearable
    ...
    <el-dialog :visible.sync="show" width="40%" :before-close="handleClose"
      class="HONGAN4D-dialog HONGAN4D-dialog_center" lock-scroll style="z-index:3000">
    ...
    getList(data) {
      ...
      for (let i = 0; i < data.list.length; i++) {
        ...
        list.push({
          ...
          dateTime: this.hongan4d.toDate(item.sendTime)
        })
      }
      if (!this.showHistory) {
        this.list = list
