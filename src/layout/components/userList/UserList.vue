<template>
  <div>
    <el-drawer title="内部聊天" :visible.sync="drawer" direction="rtl"
      class="contacts-drawer HONGAN4D-common-drawer" size="280px" :modal="true" :wrapperClosable="false"
    ...
    <Im ref="HONGAN4DIm" append-to-body />
  </div>
</template>
...
export default {
  ...
  methods: {
    ...
    readInfo(item, isReply) {
      ...
      this.$refs.HONGAN4DIm.init(item)
    },
