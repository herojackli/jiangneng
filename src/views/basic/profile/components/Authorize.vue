<template>
  <div class="authorize">
    <el-tabs v-model="activeTab" class="HONGAN4D-el_tabs">
      ...
      <el-tree :data="treeData" :props="defaultProps" default-expand-all highlight-current
        ref="treeBox" :expand-on-click-node="false" class="HONGAN4D-common-el-tree" node-key="id"
        v-loading="loading">
