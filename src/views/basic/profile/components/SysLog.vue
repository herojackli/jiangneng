<template>
  <div class="sysLog HONGAN4D-flex-main">
    ...
    <el-tabs v-model="activeName" @tab-click="handleTabClick" class="HONGAN4D-el_tabs">
      <el-tab-pane label="登录日志" name="1">
        <HONGAN4D-table v-loading="listLoading" :data="loginLogData" tooltip-effect="dark">
          <el-table-column prop="creatorTime" label="登录时间" :formatter="hongan4d.tableDateFormat"
            width="120" />
      ...
      <el-tab-pane label="请求日志" name="5">
        <HONGAN4D-table v-loading="listLoading" :data="requestLogData" tooltip-effect="dark">
          <el-table-column prop="creatorTime" label="请求时间" :formatter="hongan4d.tableDateFormat"
            width="120" />
