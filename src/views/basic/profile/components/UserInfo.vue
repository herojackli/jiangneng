<template>
  <div class="userInfo">
    <el-tabs class="HONGAN4D-el_tabs">
...
export default {
  ...
  computed: {
    creatorTime() {
      return this.hongan4d.toDate(this.form.creatorTime)
    },
    entryDate() {
      return this.hongan4d.toDate(this.form.entryDate)
    },
    prevLogTime() {
      return this.hongan4d.toDate(this.form.prevLogTime)
    },
  },
  created() {
    this.getOptions()
