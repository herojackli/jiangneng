<template>
  <el-dialog :title="!dataForm.id ? '新建分类' : '编辑分类'" :close-on-click-modal="false"
    :visible.sync="visible" :append-to-body="true" class="HONGAN4D-dialog HONGAN4D-dialog_center"
    lock-scroll width="600px">
    <el-form ref="dataForm" :model="dataForm" :rules="dataRule" v-loading="formLoading"
      label-width="60px">
      <el-form-item label="上级" prop="parentId">
        <HONGAN4D-TreeSelect v-model="dataForm.parentId" :options="treeData" placeholder="选择项目上级" />
      </el-form-item>
