  ...
  <div class="HONGAN4D-common-layout">
    <div class="HONGAN4D-common-layout-center">
      ...
      <div class="HONGAN4D-common-layout-main HONGAN4D-flex-main">
        ...
        <HONGAN4D-table v-loading="listLoading" :data="tableList">
          ...
          <el-table-column prop="creatorTime" :formatter="hongan4d.tableDateFormat" sortable
...
export default {
  ...
  methods: {
    ...
    handleDownload(fileUrl) {
      this.hongan4d.downloadFile(fileUrl)
    },
    search() {
