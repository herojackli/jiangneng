<template>
  <el-dialog title="批量新增" :close-on-click-modal="false" :close-on-press-escape="false"
    :visible.sync="visible" lock-scroll class="HONGAN4D-dialog HONGAN4D-dialog_center" width="600px">
    <el-form ref="dataForm" :model="dataForm" :rules="dataRule" label-width="80px"
      ...
      <el-form-item label="字段Json" prop="columnJson">
        <div class="formCodeEditor">
          <HONGAN4DCodeEditor :options="options" v-model="content" ref="CodeEditor" />
        </div>
      </el-form-item>
    </el-form>
