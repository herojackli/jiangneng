  ...
  methods: {
    initData() {
      getSystemMonitor().then(res => {
        ...
        this.cpuInfo.xAxis.data.push(this.hongan4d.dateFormat(this.data.time, 'HH:mm:ss'))
        this.memoryInfo.xAxis.data.push(this.hongan4d.dateFormat(this.data.time, 'HH:mm:ss'))
