<template>
  <div class="app-container HONGAN4D-flex-main systemConfig">
    <el-form ref="baseForm" :model="baseForm" :rules="rules" label-width="100px">
      <el-tabs v-model="activeName" type="border-card" class="HONGAN4D-el_tabs">
          ...
          <el-tabs tab-position="left" style="height:100%" v-model="thirdTab" class="thirdTab">
            <el-tab-pane label="阿里短信">
              ...
              <el-row style="margin-top: 15px" v-if="thirdTab=='0'">
                <el-col :span="12">
                  <hongan4d-form-tip-item label="AccessKey ID" prop="aliAccessKey" label-width="180px"
                  ...
                  <hongan4d-form-tip-item label="AccessKey Secret" prop="aliSecret" label-width="180px"
