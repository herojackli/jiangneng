<template>
  <transition name="el-zoom-in-center">
    <div class="HONGAN4D-preview-main org-form">
      ...
      <div class="main" v-loading="formLoading">
        <el-form ref="dataForm" :model="dataForm" :rules="dataRule" label-width="80px">
          <div class="HONGAN4D-common-title mb-20">
            <h2 class="bold">基础信息</h2>
          </div>
          <el-row :gutter="20" class="custom-row">
            <el-col :sm="12" :xs="24">
              <el-form-item label="上级公司" prop="parentId">
                <HONGAN4D-TreeSelect v-model="dataForm.parentId" :options="treeData"
            ...
            <el-col :sm="12" :xs="24">
              <el-form-item label="公司性质" prop="propertyJson.enterpriseNature">
                <HONGAN4D-TreeSelect v-model="dataForm.propertyJson.enterpriseNature"
                  :options="natureData" placeholder="请选择公司性质" style="width: 100%" />
              </el-form-item>
            </el-col>
            <el-col :sm="12" :xs="24">
              <el-form-item label="所属行业" prop="propertyJson.industry">
                <HONGAN4D-TreeSelect v-model="dataForm.propertyJson.industry" :options="industryData"
