<template>
  <div class="HONGAN4D-common-layout HONGAN4D-flex-main">
    <div class="HONGAN4D-common-layout-center">
      ...
      <div class="HONGAN4D-common-layout-main HONGAN4D-flex-main">
        ...
        <HONGAN4D-table v-loading="listLoading" :data="tableDataList" has-c
          ...
          <el-table-column label="操作" width="90">
            <template slot-scope="scope">
              <el-button slot="reference" type="text" class="HONGAN4D-table-delBtn"
