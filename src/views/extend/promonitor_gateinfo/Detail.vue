...
<el-form ref="elForm" :model="dataForm" size="small" label-width="100px" label-position="right" >
 ...
 prop="orderindex" >
            ...
            <el-col :span="12" >
                <el-form-item  label="闸门盖高度"  
 prop="gateheight" >
                        <p>{{dataForm.gateheight}}</p>
                </el-form-item>
            </el-col>
            <el-col :span="24" >
            ...
            init(id) {
                ...
                this.$nextTick(() => {
                    if(this.dataForm.id){
                        this.loading = true
                        request({
                            url: '/api/example/ProMonitor_GateInfo/detail/'+this.dataForm.id,
                            method: 'get'
                        }).then(res => {
