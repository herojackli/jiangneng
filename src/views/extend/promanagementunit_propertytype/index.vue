        ...
        <div class="HONGAN4D-common-layout-center">
            ...
            <div class="HONGAN4D-common-layout-main HONGAN4D-flex-main">
                ...
                <HONGAN4D-table v-loading="listLoading" :data="list" @sort-change='sortChange' >
                            <el-table-column prop="propertyname" label="单位性质名称" width="0" align="left"
/>
    ...
    export default {
        ...
        data() {
            return {
                ...
                columnList: [
                    {prop: 'propertyname', label: '单位性质名称'},
                ],
            }
        },
        computed: {
        ...
        methods: {
            ...
            initData() {
                ...
                request({
                    url: `/api/example/ProManagementUnit_PropertyType/getList`,
                    method: 'post',
                    data: _query
                }).then(res => {
                    var _list =[];
            ...
            handleDel(id) {
                this.$confirm('此操作将永久删除该数据, 是否继续?', '提示', {
                    ...
                    request({
                        url: `/api/example/ProManagementUnit_PropertyType/${id}`,
                        method: 'DELETE'
                    }).then(res => {
                        this.$message({
                            type: 'success',
            ...
            download(data) {
                ...
                request({
                    url: `/api/example/ProManagementUnit_PropertyType/Actions/Export`,
                    method: 'GET',
                    data: query
                }).then(res => {
