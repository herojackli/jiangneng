                ...
                <el-form @submit.native.prevent>
                        ...
                        <el-col :span="6">
                                <el-form-item label="证书名称">
                                        <el-input v-model="query.certificatename" placeholder="请输入" clearable>  </el-input>
                                </el-form-item>
                            </el-col>
                        <el-col :span="6">
                                <el-form-item label="颁发时间">
                                        <el-date-picker v-model="query.issuetime" type="daterange"
...
/>
                            <el-table-column prop="certificatename" label="证书名称" width="0" align="left"
/>
                            <el-table-column prop="issuetime" label="颁发时间" width="0" align="left"
/>
    ...
    export default {
        ...
        methods: {
            ...
            initData() {
                ...
                request({
                    url: `/api/example/ProInfo_CertificateStatistics/getList`,
                    method: 'post',
                    data: _query
                }).then(res => {
                    var _list =[];
            ...
            handleDel(id) {
                this.$confirm('此操作将永久删除该数据, 是否继续?', '提示', {
                    ...
                    request({
                        url: `/api/example/ProInfo_CertificateStatistics/${id}`,
                        method: 'DELETE'
                    }).then(res => {
                        this.$message({
                            type: 'success',
            ...
            download(data) {
                ...
                request({
                    url: `/api/example/ProInfo_CertificateStatistics/Actions/Export`,
                    method: 'GET',
                    data: query
                }).then(res => {
