                ...
                <el-form @submit.native.prevent>
                        ...
                        <el-col :span="6">
                                <el-form-item label="泵组型式">
                                        <el-select v-model="query.pumptypeenumid" placeholder="请选择"
                                                   clearable>
                                            <el-option v-for="(item, index) in pumptypeenumidOptions" :key="index"
                        ...
                        <el-col :span="6">
                                <el-form-item label="水泵型号">
                                        <el-input v-model="query.pumpmodel" placeholder="请输入" clearable>  </el-input>
                                </el-form-item>
                            </el-col>
                    <el-col :span="6">
                        <el-form-item>
...
/>
                            <el-table-column prop="pumptypeenumid" label="泵组型式" width="0" align="left"
/>
                            <el-table-column prop="pumpmodel" label="水泵型号" width="0" align="left"
/>
                            <el-table-column prop="pumpnum" label="泵组台数" width="0" align="left"
/>
                            <el-table-column prop="installedcapacity" label="装机容量" width="0" align="left"
/>
                            <el-table-column prop="totaldesignflow" label="设计总流量" width="0" align="left"
/>
                            <el-table-column prop="designhead" label="设计扬程" width="0" align="left"
/>
    ...
    export default {
        ...
        data() {
            return {
                ...
                columnList: [
                    ...
                    {prop: 'pumptypeenumid', label: '泵组型式'},
                    {prop: 'pumpmodel', label: '水泵型号'},
                    {prop: 'pumpnum', label: '泵组台数'},
                    {prop: 'installedcapacity', label: '装机容量'},
                    {prop: 'totaldesignflow', label: '设计总流量'},
                    {prop: 'designhead', label: '设计扬程'},
                ],
                            projectguidOptions:[],
                            projectguidProps:{"label":"ProName","value":"Id"},
                            pumptypeenumidOptions:[],
                            pumptypeenumidProps:{"label":"fullName","value":"id"},
            }
        },
        computed: {
            menuId() {
        ...
        methods: {
            ...
            initData() {
                ...
                request({
                    url: `/api/example/ProInfo_PumpBase/getList`,
                    method: 'post',
                    data: _query
                }).then(res => {
                    var _list =[];
            ...
            handleDel(id) {
                this.$confirm('此操作将永久删除该数据, 是否继续?', '提示', {
                    ...
                    request({
                        url: `/api/example/ProInfo_PumpBase/${id}`,
                        method: 'DELETE'
                    }).then(res => {
                        this.$message({
                            type: 'success',
            ...
            download(data) {
                ...
                request({
                    url: `/api/example/ProInfo_PumpBase/Actions/Export`,
                    method: 'GET',
                    data: query
                }).then(res => {
