        ...
        <div class="HONGAN4D-common-layout-center">
                ...
                <el-form @submit.native.prevent>
                        ...
                        <el-col :span="6">
                                <el-form-item label="体检日期">
                                        <el-date-picker v-model="query.physicalexaminationdate" type="daterange"
            ...
            <div class="HONGAN4D-common-layout-main HONGAN4D-flex-main">
                ...
                <HONGAN4D-table v-loading="listLoading" :data="list" @sort-change='sortChange' >
                            <el-table-column prop="userid" label="员工姓名" width="0" align="left"
/>
                            <el-table-column prop="supplementguid" label="管理单位" width="0" align="left"
/>
                            <el-table-column prop="physicalexaminationdate" label="体检日期" width="0" align="left"
 sortable="custom" />
    ...
    export default {
        ...
        data() {
            return {
                ...
                query: {
                                ...
                                physicalexaminationdate:undefined,
                },
                treeProps: {
                    children: 'children',
                    label: 'fullName',
                ...
                columnList: [
                    {prop: 'userid', label: '员工姓名'},
                    {prop: 'supplementguid', label: '管理单位'},
                    {prop: 'physicalexaminationdate', label: '体检日期'},
                ],
        ...
        methods: {
            ...
            initData() {
                ...
                request({
                    url: `/api/example/ProInfo_Entry_PhysicalExamination/getList`,
                    method: 'post',
                    data: _query
                }).then(res => {
                    var _list =[];
            ...
            handleDel(id) {
                this.$confirm('此操作将永久删除该数据, 是否继续?', '提示', {
                    ...
                    request({
                        url: `/api/example/ProInfo_Entry_PhysicalExamination/${id}`,
                        method: 'DELETE'
                    }).then(res => {
                        this.$message({
                            type: 'success',
            ...
            download(data) {
                ...
                request({
                    url: `/api/example/ProInfo_Entry_PhysicalExamination/Actions/Export`,
                    method: 'GET',
                    data: query
                }).then(res => {
