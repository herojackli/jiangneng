      ...
      this.$nextTick(() => {
        if (this.dataForm.id) {
          ...
          Info('crmOrder', this.dataForm.id).then(res => {
            ...
            this.dataForm.orderDate = this.hongan4d.toDate(this.dataForm.orderDate)
            this.dataForm.deliveryDate = this.hongan4d.toDate(this.dataForm.deliveryDate, "yyyy-MM-dd")
