...
<el-form ref="elForm" :model="dataForm" :rules="rules" size="small" label-width="100px" label-position="right" >
 ...
 prop="technicaldataname" >
                    <el-input    v-model="dataForm.technicaldataname"
    ...
    export default {
        ...
        methods: {
            ...
            init(id, isDetail) {
                ...
                this.$nextTick(() => {
                    ...
                    if(this.dataForm.id){
                        this.loading = true
                        request({
                            url: '/api/example/ProInfo_TechnicalData/'+this.dataForm.id,
                            method: 'get'
                        }).then(res => {
            ...
            request() {
                ...
                if (!this.dataForm.id) {
                    request({
                        url: '/api/example/ProInfo_TechnicalData',
                        method: 'post',
                        data: _data
                    }).then((res) => {
                        this.$message({
