<template>
        ...
        <div class="HONGAN4D-common-layout-center">
            <el-row class="HONGAN4D-common-search-box" :gutter="16">
                <el-form @submit.native.prevent>
                        ...
                        <el-col :span="6">
                                <el-form-item label="技术资料名称">
                                        <el-input v-model="query.technicaldataname" placeholder="请输入" clearable>  </el-input>
                                </el-form-item>
                            </el-col>
                    <el-col :span="6">
                        <el-form-item>
 ...
 sortable="custom" />
                            <el-table-column prop="technicaldataname" label="技术资料名称" width="0" align="left"
/>
    ...
    export default {
        ...
        data() {
            return {
                ...
                columnList: [
                    ...
                    {prop: 'technicaldataname', label: '技术资料名称'},
                ],
            }
        },
        computed: {
        ...
        methods: {
            ...
            initData() {
                ...
                request({
                    url: `/api/example/ProInfo_TechnicalData/getList`,
                    method: 'post',
                    data: _query
                }).then(res => {
                    var _list =[];
            ...
            handleDel(id) {
                this.$confirm('此操作将永久删除该数据, 是否继续?', '提示', {
                    ...
                    request({
                        url: `/api/example/ProInfo_TechnicalData/${id}`,
                        method: 'DELETE'
                    }).then(res => {
                        this.$message({
                            type: 'success',
            ...
            download(data) {
                ...
                request({
                    url: `/api/example/ProInfo_TechnicalData/Actions/Export`,
                    method: 'GET',
                    data: query
                }).then(res => {
