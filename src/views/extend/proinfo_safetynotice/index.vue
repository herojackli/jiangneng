                ...
                <el-form @submit.native.prevent>
                        ...
                        <el-col :span="6">
                                <el-form-item label="文件名称">
                                        <el-input v-model="query.filename" placeholder="请输入" clearable>  </el-input>
                                </el-form-item>
                            </el-col>
                    <el-col :span="6">
                        <el-form-item>
...
/>
                            <el-table-column prop="creatoruserid" label="创建用户" width="0" align="left"
/>
                            <el-table-column prop="filename" label="文件名称" width="0" align="left"
/>
    ...
    export default {
        ...
        methods: {
            ...
            initData() {
                ...
                request({
                    url: `/api/example/ProInfo_SafetyNotice/getList`,
                    method: 'post',
                    data: _query
                }).then(res => {
                    var _list =[];
            ...
            handleDel(id) {
                this.$confirm('此操作将永久删除该数据, 是否继续?', '提示', {
                    ...
                    request({
                        url: `/api/example/ProInfo_SafetyNotice/${id}`,
                        method: 'DELETE'
                    }).then(res => {
                        this.$message({
                            type: 'success',
            ...
            download(data) {
                ...
                request({
                    url: `/api/example/ProInfo_SafetyNotice/Actions/Export`,
                    method: 'GET',
                    data: query
                }).then(res => {
