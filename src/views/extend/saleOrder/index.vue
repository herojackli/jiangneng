<template>
  <div class="HONGAN4D-common-layout sale-order-main">
    <div class="HONGAN4D-common-layout-center">
      ...
      <div class="HONGAN4D-common-layout-main HONGAN4D-flex-main">
        ...
        <HONGAN4D-table v-loading="listLoading" :data="list" has-c @selection-change="handleChange"
        ...
        <div class="sale-order-footer">
          <HONGAN4D-table :data="productEntryList" highlight-current-row @row-click="rowClick1">
          ...
          <HONGAN4D-table :data="childrenList" class="ml-10">
