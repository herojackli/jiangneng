...
<el-form ref="elForm" :model="dataForm" :rules="rules" size="small" label-width="100px" label-position="right" >
 ...
 prop="handleresult" >
                    <el-input    v-model="dataForm.handleresult"
 placeholder="请输入"  :style='{"width":"100%"}' true  type="textarea"  :autosize='{"minRows":4,"maxRows":4}' >
    ...
    export default {
        ...
        methods: {
            ...
            init(id, isDetail) {
                ...
                this.$nextTick(() => {
                    ...
                    if(this.dataForm.id){
                        this.loading = true
                        request({
                            url: '/api/example/ProInfo_DailyInspection/'+this.dataForm.id,
                            method: 'get'
                        }).then(res => {
            ...
            request() {
                ...
                if (!this.dataForm.id) {
                    request({
                        url: '/api/example/ProInfo_DailyInspection',
                        method: 'post',
                        data: _data
                    }).then((res) => {
                        this.$message({
            ...
            dataList(){
                var _data = JSON.parse(JSON.stringify(this.dataForm));
                        ...
                        _data.handleprofileid = JSON.stringify(_data.handleprofileid)
                return _data;
            },
            dataInfo(dataAll){
                let _dataAll =dataAll
                        ...
                        _dataAll.handleprofileid = JSON.parse( _dataAll.handleprofileid)
