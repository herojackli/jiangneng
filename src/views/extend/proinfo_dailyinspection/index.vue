        ...
        <div class="HONGAN4D-common-layout-center">
            <el-row class="HONGAN4D-common-search-box" :gutter="16">
                <el-form @submit.native.prevent>
                                ...
                                <el-form-item label="记录类型">
                                        <el-select v-model="query.recordtypeenumid" placeholder="请选择"
                                                   clearable>
                                            <el-option v-for="(item, index) in recordtypeenumidOptions" :key="index"
                        ...
                        <el-col :span="6">
                                <el-form-item label="检查日期">
                                        <el-date-picker v-model="query.inspectiondate" type="daterange"
                        ...
                        <template v-if="showAll">
                                    ...
                                    <el-col :span="6">
                                        <el-form-item label="处理结果">
                                                <el-input v-model="query.handleresult" placeholder="请输入" clearable>  </el-input>
                                        </el-form-item>
                                    </el-col>
                        </template>
                    <el-col :span="6">
            ...
            <div class="HONGAN4D-common-layout-main HONGAN4D-flex-main">
                ...
                <HONGAN4D-table v-loading="listLoading" :data="list" @sort-change='sortChange' >
                            <el-table-column prop="recordtypeenumid" label="记录类型" width="0" align="left"
/>
                            <el-table-column prop="inspectiondate" label="检查日期" width="0" align="left"
 sortable="custom" />
                            <el-table-column prop="projectguid" label="工程" width="0" align="left"
/>
                            <el-table-column prop="principalpersonid" label="负责人" width="0" align="left"
/>
                            <el-table-column prop="inspectorids" label="检查人员" width="0" align="left"
/>
                            <el-table-column prop="inspectionresult" label="检查结论" width="0" align="left"
/>
                            <el-table-column prop="handleresult" label="处理结果" width="0" align="left"
/>
    ...
    export default {
        ...
        data() {
            return {
                ...
                columnList: [
                    {prop: 'recordtypeenumid', label: '记录类型'},
                    {prop: 'inspectiondate', label: '检查日期'},
                    {prop: 'projectguid', label: '工程'},
                    {prop: 'principalpersonid', label: '负责人'},
                    {prop: 'inspectorids', label: '检查人员'},
                    {prop: 'inspectionresult', label: '检查结论'},
                    {prop: 'handleresult', label: '处理结果'},
                ],
                            projectguidOptions:[],
                            projectguidProps:{"label":"ProName","value":"Id"},
                            recordtypeenumidOptions:[],
                            recordtypeenumidProps:{"label":"fullName","value":"id"},
            }
        },
        computed: {
            menuId() {
        ...
        methods: {
            ...
            initData() {
                ...
                request({
                    url: `/api/example/ProInfo_DailyInspection/getList`,
                    method: 'post',
                    data: _query
                }).then(res => {
                    var _list =[];
            ...
            handleDel(id) {
                this.$confirm('此操作将永久删除该数据, 是否继续?', '提示', {
                    ...
                    request({
                        url: `/api/example/ProInfo_DailyInspection/${id}`,
                        method: 'DELETE'
                    }).then(res => {
                        this.$message({
                            type: 'success',
            ...
            download(data) {
                ...
                request({
                    url: `/api/example/ProInfo_DailyInspection/Actions/Export`,
                    method: 'GET',
                    data: query
                }).then(res => {
