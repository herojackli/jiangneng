        ...
        <div class="HONGAN4D-common-layout-center">
            <el-row class="HONGAN4D-common-search-box" :gutter="16">
                <el-form @submit.native.prevent>
                                ...
                                <el-form-item label="路线名称">
                                        <el-input v-model="query.routename" placeholder="请输入" clearable>  </el-input>
                                </el-form-item>
                            </el-col>
                        <el-col :span="6">
                                <el-form-item label="起点地址">
                                        <el-input v-model="query.startaddress" placeholder="请输入" clearable>  </el-input>
                                </el-form-item>
                            </el-col>
                        <el-col :span="6">
                                <el-form-item label="终点地址">
                                        <el-input v-model="query.endaddress" placeholder="请输入" clearable>  </el-input>
                                </el-form-item>
                            </el-col>
                    <el-col :span="6">
                        <el-form-item>
            ...
            <div class="HONGAN4D-common-layout-main HONGAN4D-flex-main">
                ...
                <HONGAN4D-table v-loading="listLoading" :data="list" @sort-change='sortChange' >
                            <el-table-column prop="routename" label="路线名称" width="0" align="left"
/>
                            <el-table-column prop="startaddress" label="起点地址" width="0" align="left"
/>
                            <el-table-column prop="endaddress" label="终点地址" width="0" align="left"
/>
    ...
    export default {
        ...
        methods: {
            ...
            initData() {
                ...
                request({
                    url: `/api/example/ProInfo_PatrolRoute/getList`,
                    method: 'post',
                    data: _query
                }).then(res => {
                    var _list =[];
            ...
            handleDel(id) {
                this.$confirm('此操作将永久删除该数据, 是否继续?', '提示', {
                    ...
                    request({
                        url: `/api/example/ProInfo_PatrolRoute/${id}`,
                        method: 'DELETE'
                    }).then(res => {
                        this.$message({
                            type: 'success',
            ...
            download(data) {
                ...
                request({
                    url: `/api/example/ProInfo_PatrolRoute/Actions/Export`,
                    method: 'GET',
                    data: query
                }).then(res => {
