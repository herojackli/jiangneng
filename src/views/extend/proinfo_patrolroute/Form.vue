...
<el-form ref="elForm" :model="dataForm" :rules="rules" size="small" label-width="100px" label-position="right" >
 ...
 prop="routename" >
                    <el-input    v-model="dataForm.routename"
 ...
 prop="startaddress" >
                    <el-input    v-model="dataForm.startaddress"
 placeholder="请输入"  clearable  :style='{"width":"100%"}'>
 ...
 prop="endaddress" >
                    <el-input    v-model="dataForm.endaddress"
 placeholder="请输入"  clearable  :style='{"width":"100%"}'>
    ...
    export default {
        ...
        methods: {
            ...
            init(id, isDetail) {
                ...
                this.$nextTick(() => {
                    ...
                    if(this.dataForm.id){
                        this.loading = true
                        request({
                            url: '/api/example/ProInfo_PatrolRoute/'+this.dataForm.id,
                            method: 'get'
                        }).then(res => {
            ...
            request() {
                ...
                if (!this.dataForm.id) {
                    request({
                        url: '/api/example/ProInfo_PatrolRoute',
                        method: 'post',
                        data: _data
                    }).then((res) => {
                        this.$message({
