        ...
        <div class="HONGAN4D-common-layout-center">
            ...
            <div class="HONGAN4D-common-layout-main HONGAN4D-flex-main">
                ...
                <HONGAN4D-table v-loading="listLoading" :data="list" @sort-change='sortChange' >
                            <el-table-column prop="filename" label="文件名" width="0" align="left"
/>
    ...
    export default {
        ...
        methods: {
            ...
            initData() {
                ...
                request({
                    url: `/api/example/ProRunning_Scheduling/getList`,
                    method: 'post',
                    data: _query
                }).then(res => {
                    var _list =[];
            ...
            handleDel(id) {
                this.$confirm('此操作将永久删除该数据, 是否继续?', '提示', {
                    ...
                    request({
                        url: `/api/example/ProRunning_Scheduling/${id}`,
                        method: 'DELETE'
                    }).then(res => {
                        this.$message({
                            type: 'success',
            ...
            download(data) {
                ...
                request({
                    url: `/api/example/ProRunning_Scheduling/Actions/Export`,
                    method: 'GET',
                    data: query
                }).then(res => {
