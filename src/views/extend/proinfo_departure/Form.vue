...
<el-form ref="elForm" :model="dataForm" :rules="rules" size="small" label-width="100px" label-position="right" >
 ...
 prop="departuretime" >
                    <el-date-picker    v-model="dataForm.departuretime"
 placeholder="请选择"  clearable  :style='{"width":"100%"}' type="date"  format="yyyy-MM-dd"  value-format="timestamp" >
 ...
 prop="handoverid" >
                    <user-select    v-model="dataForm.handoverid"
 placeholder="请选择"  clearable >
 ...
 prop="laborcontractstarttime" >
                    <el-date-picker    v-model="dataForm.laborcontractstarttime"
 placeholder="请选择"  clearable  :style='{"width":"100%"}' type="date"  format="yyyy-MM-dd"  value-format="timestamp" >
 ...
 prop="laborcontractendtime" >
                    <el-date-picker    v-model="dataForm.laborcontractendtime"
 placeholder="请选择"  clearable  :style='{"width":"100%"}' type="date"  format="yyyy-MM-dd"  value-format="timestamp" >
 ...
 prop="departurereason" >
                    <el-input    v-model="dataForm.departurereason"
 ...
 prop="handovermatter" >
                    <el-input    v-model="dataForm.handovermatter"
 placeholder="请输入"  clearable  :style='{"width":"100%"}'>
    ...
    export default {
        ...
        methods: {
            ...
            init(id, isDetail) {
                ...
                this.$nextTick(() => {
                    ...
                    if(this.dataForm.id){
                        this.loading = true
                        request({
                            url: '/api/example/ProInfo_Departure/'+this.dataForm.id,
                            method: 'get'
                        }).then(res => {
            ...
            request() {
                ...
                if (!this.dataForm.id) {
                    request({
                        url: '/api/example/ProInfo_Departure',
                        method: 'post',
                        data: _data
                    }).then((res) => {
                        this.$message({
