  ...
  <div class="app-container Document-container nohead">
    <el-tabs tab-position="left" style="height:100%" v-model="activeTab">
      <el-tab-pane name="allPanel">
        ...
        <div class="main HONGAN4D-flex-main">
          ...
          <el-row class="HONGAN4D-common-search-box" :gutter="16">
            ...
            <div class="HONGAN4D-common-search-box-right">
              <el-button @click="addFolder()">新建文件夹</el-button>
              <el-button type="primary" icon="el-icon-upload2" @click="uploadFile()">上传文件
              </el-button>
            </div>
          </el-row>
          <HONGAN4D-table v-loading="listLoading" :data="list" empty-text="该文件夹为空" size="mini">
            ...
            <el-table-column prop="creatorTime" label="创建日期" :formatter="hongan4d.tableDateFormat"
              width="120" />
      ...
      <el-tab-pane name="shareoutPanel">
        ...
        <div class="main HONGAN4D-flex-main">
          ...
          <HONGAN4D-table v-loading="listLoading" :data="list" empty-text="该文件夹为空" size="mini">
            ...
            <el-table-column prop="shareTime" label="共享日期" :formatter="hongan4d.tableDateFormat"
              width="120" />
      ...
      <el-tab-pane name="trashPanel">
        ...
        <div class="main HONGAN4D-flex-main">
          ...
          <HONGAN4D-table v-loading="listLoading" :data="list" empty-text="该文件夹为空" size="mini">
            ...
            <el-table-column prop="deleteTime" label="删除日期" :formatter="hongan4d.tableDateFormat"
              width="120" />
  ...
  methods: {
    ...
    handleDownLoad(id) {
      Download(id).then(res => {
        this.hongan4d.downloadFile(res.data.url, res.data.name)
      })
    },
    // 打开文件夹
    openFolder(item) {
...
.Document-container {
  position: relative;
  .HONGAN4D-common-search-box {
    margin-bottom: 0;
    padding-left: 0;
  }
  .HONGAN4D-common-head {
    padding: 14px 0 10px;
  }
  >>> .el-tabs__item {
