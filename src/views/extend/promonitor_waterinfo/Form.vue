...
<el-form ref="elForm" :model="dataForm" :rules="rules" size="small" label-width="100px" label-position="right" >
 ...
 prop="stnm" >
                    <el-input    v-model="dataForm.stnm"
 ...
 prop="stationTypeenumid" >
                    <el-select    v-model="dataForm.stationTypeenumid"
 placeholder="请选择"  clearable  :style='{"width":"100%"}'>
                            <el-option v-for="(item, index) in stationTypeenumidOptions" :key="index" :label="item.fullName" :value="item.id" :disabled="item.disabled" ></el-option>
 ...
 prop="adcd" >
                    <HONGAN4D-Address    v-model="dataForm.adcd"
 ...
 prop="blendercode" >
                    <el-input    v-model="dataForm.blendercode"
 placeholder="请输入"  clearable  :style='{"width":"100%"}'>
 ...
 prop="blenderx" >
                    <el-input-number    v-model="dataForm.blenderx"
 placeholder="数字文本"  :step="1"  :precision="6" >
 ...
 prop="blendery" >
                    <el-input-number    v-model="dataForm.blendery"
 placeholder="数字文本"  :step="1"  :precision="6" >
 ...
 prop="blenderz" >
                    <el-input-number    v-model="dataForm.blenderz"
 placeholder="数字文本"  :step="1"  :precision="6" >
    ...
    export default {
        ...
        methods: {
            ...
            init(id, isDetail) {
                ...
                this.$nextTick(() => {
                    ...
                    if(this.dataForm.id){
                        this.loading = true
                        request({
                            url: '/api/example/ProMonitor_WaterInfo/'+this.dataForm.id,
                            method: 'get'
                        }).then(res => {
            ...
            request() {
                ...
                if (!this.dataForm.id) {
                    request({
                        url: '/api/example/ProMonitor_WaterInfo',
                        method: 'post',
                        data: _data
                    }).then((res) => {
                        this.$message({
            ...
            dataList(){
                var _data = JSON.parse(JSON.stringify(this.dataForm));
                        _data.adcd = JSON.stringify(_data.adcd)
                return _data;
            },
            dataInfo(dataAll){
                let _dataAll =dataAll
                        _dataAll.adcd = JSON.parse( _dataAll.adcd)
