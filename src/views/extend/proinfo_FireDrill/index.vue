        ...
        <div class="HONGAN4D-common-layout-center">
                ...
                <el-form @submit.native.prevent>
                        ...
                        <el-col :span="6">
                                <el-form-item label="归档时间">
                                        <el-date-picker v-model="query.archivetime" type="daterange"
                                                        value-format="timestamp" format="yyyy-MM-dd" start-placeholder="开始日期"
                                                        end-placeholder="结束日期" >
                                        </el-date-picker>
                                </el-form-item>
                        ...
                        <template v-if="showAll">
                                    <el-col :span="6">
                                        <el-form-item label="负责人">
                                                <user-select  v-model="query.principalpersonid" placeholder="请选择
                                                " clearable/>
                                        </el-form-item>
                                    </el-col>
                                    <el-col :span="6">
                                        <el-form-item label="演练类型">
                                                <el-select v-model="query.drilltypeenumid" placeholder="请选择"
                                                           clearable>
                                                    <el-option v-for="(item, index) in drilltypeenumidOptions" :key="index"
                                                               :label="item.fullName" :value="item.id"
                                                               :disabled="item.disabled"></el-option>
                                                </el-select>
                                        </el-form-item>
                                    ...
                                    <el-col :span="6">
                                        <el-form-item label="归档状态">
                                                <el-select v-model="query.archivestatusenumid" placeholder="请选择"
                                                           clearable>
                                                    <el-option v-for="(item, index) in archivestatusenumidOptions" :key="index"
                                                               :label="item.fullName" :value="item.id"
                                                               :disabled="item.disabled"></el-option>
                                                </el-select>
                                        </el-form-item>
            ...
            <div class="HONGAN4D-common-layout-main HONGAN4D-flex-main">
                ...
                <HONGAN4D-table v-loading="listLoading" :data="list" @sort-change='sortChange' >
                                <el-table-column label="工程ID" width="0" prop="projectguid" algin="left"
>
                                    <template slot-scope="scope">
                                        {{ scope.row.projectguid | dynamicText(projectguidOptions) }}
                                    </template>
                                </el-table-column>
                            <el-table-column prop="drilltypeenumid" label="演练类型" width="0" align="left"
/>
                            <el-table-column prop="starttime" label="开始时间" width="0" align="left"
 sortable="custom" />
                            <el-table-column prop="endtime" label="结束时间" width="0" align="left"
 sortable="custom" />
                            <el-table-column prop="principalpersonid" label="负责人" width="0" align="left"
/>
                            <el-table-column prop="participants" label="参与人员" width="0" align="left"
/>
                            <el-table-column prop="drillcontent" label="演练内容" width="0" align="left"
/>
                            <el-table-column prop="archivetime" label="归档时间" width="0" align="left"
 sortable="custom" />
                            <el-table-column prop="archivestatusenumid" label="归档状态" width="0" align="left"
/>
    ...
    export default {
        ...
        data() {
            return {
                ...
                query: {
                                ...
                                principalpersonid:undefined,
                                drilltypeenumid:undefined,
                                archivestatusenumid:undefined,
                },
                treeProps: {
                    children: 'children',
                    label: 'fullName',
                ...
                columnList: [
                    ...
                    {prop: 'drilltypeenumid', label: '演练类型'},
                    {prop: 'starttime', label: '开始时间'},
                    {prop: 'endtime', label: '结束时间'},
                    {prop: 'principalpersonid', label: '负责人'},
                    {prop: 'participants', label: '参与人员'},
                    {prop: 'drillcontent', label: '演练内容'},
                    {prop: 'archivetime', label: '归档时间'},
                    {prop: 'archivestatusenumid', label: '归档状态'},
                ],
                                projectguidOptions:[{"fullName":"工程","id":"江能建设工程"}],
                            projectguidProps:{"label":"fullName","value":"id"},
                            drilltypeenumidOptions:[],
                            drilltypeenumidProps:{"label":"fullName","value":"id"},
                            archivestatusenumidOptions:[],
                            archivestatusenumidProps:{"label":"fullName","value":"id"},
            }
        },
        computed: {
            menuId() {
        ...
        methods: {
            ...
            initData() {
                ...
                request({
                    url: `/api/example/ProInfo_EmergencyDrill/getList`,
                    method: 'post',
                    data: _query
                }).then(res => {
                    var _list =[];
            ...
            handleDel(id) {
                this.$confirm('此操作将永久删除该数据, 是否继续?', '提示', {
                    ...
                    request({
                        url: `/api/example/ProInfo_EmergencyDrill/${id}`,
                        method: 'DELETE'
                    }).then(res => {
                        this.$message({
                            type: 'success',
            ...
            download(data) {
                ...
                request({
                    url: `/api/example/ProInfo_EmergencyDrill/Actions/Export`,
                    method: 'GET',
                    data: query
                }).then(res => {
