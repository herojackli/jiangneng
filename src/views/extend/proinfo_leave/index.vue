        ...
        <div class="HONGAN4D-common-layout-center">
            <el-row class="HONGAN4D-common-search-box" :gutter="16">
                <el-form @submit.native.prevent>
                                ...
                                <el-form-item label="人员ID">
                                        <userSelect v-model="query.userid" placeholder="请选择" />
                                </el-form-item>
                            </el-col>
                        <el-col :span="6">
                                <el-form-item label="时长">
                                        <num-range v-model="query.duration"></num-range>
                                </el-form-item>
                            </el-col>
                    <el-col :span="6">
                        <el-form-item>
            ...
            <div class="HONGAN4D-common-layout-main HONGAN4D-flex-main">
                ...
                <HONGAN4D-table v-loading="listLoading" :data="list" @sort-change='sortChange' >
                            <el-table-column prop="userid" label="人员ID" width="0" align="left"
/>
                            <el-table-column prop="leavereason" label="请假事由" width="0" align="left"
/>
                            <el-table-column prop="starttime" label="请假开始时间" width="0" align="left"
/>
                            <el-table-column prop="endtime" label="结束时间" width="0" align="left"
/>
                            <el-table-column prop="duration" label="时长" width="0" align="left"
/>
    ...
    export default {
        ...
        methods: {
            ...
            initData() {
                ...
                request({
                    url: `/api/example/ProInfo_Leave/getList`,
                    method: 'post',
                    data: _query
                }).then(res => {
                    var _list =[];
            ...
            handleDel(id) {
                this.$confirm('此操作将永久删除该数据, 是否继续?', '提示', {
                    ...
                    request({
                        url: `/api/example/ProInfo_Leave/${id}`,
                        method: 'DELETE'
                    }).then(res => {
                        this.$message({
                            type: 'success',
            ...
            download(data) {
                ...
                request({
                    url: `/api/example/ProInfo_Leave/Actions/Export`,
                    method: 'GET',
                    data: query
                }).then(res => {
