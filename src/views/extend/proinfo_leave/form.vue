<template>
 ...
 prop="userid" >
					<el-input  :disabled="judgeWrite('userid')"  v-model="dataForm.userid"
 ...
 prop="starttime" >
					<el-date-picker  :disabled="judgeWrite('starttime')"  v-model="dataForm.starttime"
 ...
 prop="endtime" >
					<el-date-picker  :disabled="judgeWrite('endtime')"  v-model="dataForm.endtime"
 placeholder="请选择"  clearable  :style='{"width":"100%"}' type="date"  format="yyyy-MM-dd"  value-format="timestamp" >
			...
			<el-col :span="24"    v-if="judgeShow('duration')" >
				<el-form-item  label="时长"  
 prop="duration" >
					<el-input-number  :disabled="judgeWrite('duration')"  v-model="dataForm.duration"
 ...
 prop="leavereason" >
					<el-input  :disabled="judgeWrite('leavereason')"  v-model="dataForm.leavereason"
            ...
            init(data) {
                ...
                this.$nextTick(() => {
                    ...
                    if(this.dataForm.id){
                        this.loading = true
                        request({
                            url: '/api/example/ProInfo_Leave/'+this.dataForm.id,
                            method: 'get'
                        }).then(res => {
