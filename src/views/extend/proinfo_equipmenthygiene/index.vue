                ...
                <el-form @submit.native.prevent>
                        ...
                        <el-col :span="6">
                                <el-form-item label="包干区名称">
                                        <el-input v-model="query.lumpsumareaname" placeholder="请输入" clearable>  </el-input>
                                </el-form-item>
                            </el-col>
                        <el-col :span="6">
                                <el-form-item label="参与人员">
                                        <user-select  v-model="query.participants" placeholder="请选择
                                        " clearable/>
                                </el-form-item>
                            </el-col>
                        <template v-if="showAll">
                                    <el-col :span="6">
                                        <el-form-item label="时间">
                                                <el-date-picker v-model="query.tm" type="daterange"
...
/>
                            <el-table-column prop="lumpsumareaname" label="包干区名称" width="0" align="left"
/>
                            <el-table-column prop="participants" label="参与人员" width="0" align="left"
/>
                            <el-table-column prop="tm" label="时间" width="0" align="left"
/>
    ...
    export default {
        ...
        data() {
            return {
                ...
                columnList: [
                    ...
                    {prop: 'lumpsumareaname', label: '包干区名称'},
        ...
        methods: {
            ...
            initData() {
                ...
                request({
                    url: `/api/example/ProInfo_EquipmentHygiene/getList`,
                    method: 'post',
                    data: _query
                }).then(res => {
                    var _list =[];
            ...
            handleDel(id) {
                this.$confirm('此操作将永久删除该数据, 是否继续?', '提示', {
                    ...
                    request({
                        url: `/api/example/ProInfo_EquipmentHygiene/${id}`,
                        method: 'DELETE'
                    }).then(res => {
                        this.$message({
                            type: 'success',
            ...
            download(data) {
                ...
                request({
                    url: `/api/example/ProInfo_EquipmentHygiene/Actions/Export`,
                    method: 'GET',
                    data: query
                }).then(res => {
