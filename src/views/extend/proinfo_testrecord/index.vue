                        ...
                        <template v-if="showAll">
                                    <el-col :span="6">
                                        <el-form-item label="试验人员">
                                                <user-select  v-model="query.inspectorids" placeholder="请选择
                                                " clearable/>
                                        </el-form-item>
                                    </el-col>
                        </template>
...
/>
                            <el-table-column prop="inspectorids" label="试验人员" width="0" align="left"
/>
                            <el-table-column prop="inspectionresult" label="试验结论" width="0" align="left"
/>
    ...
    export default {
        ...
        data() {
            return {
                ...
                columnList: [
                    ...
                    {prop: 'inspectorids', label: '试验人员'},
                    {prop: 'inspectionresult', label: '试验结论'},
        ...
        methods: {
            ...
            initData() {
                ...
                request({
                    url: `/api/example/ProInfo_TestRecord/getList`,
                    method: 'post',
                    data: _query
                }).then(res => {
                    var _list =[];
            ...
            handleDel(id) {
                this.$confirm('此操作将永久删除该数据, 是否继续?', '提示', {
                    ...
                    request({
                        url: `/api/example/ProInfo_TestRecord/${id}`,
                        method: 'DELETE'
                    }).then(res => {
                        this.$message({
                            type: 'success',
            ...
            download(data) {
                ...
                request({
                    url: `/api/example/ProInfo_TestRecord/Actions/Export`,
                    method: 'GET',
                    data: query
                }).then(res => {
