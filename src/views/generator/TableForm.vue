<template>
  <el-dialog title="数据选择" :close-on-click-modal="false" width="700px"
    class="HONGAN4D-dialog HONGAN4D-dialog_center table-dialog" lock-scroll append-to-body v-bind="$attrs"
    ...
    <HONGAN4D-table v-loading="listLoading" :data="list" hasC @selection-change="handleSelectionChange"
      :border="false">
