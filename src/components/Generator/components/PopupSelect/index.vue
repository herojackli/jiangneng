  ...
  <div class="popupSelect-container">
    ...
    <template v-if="popupType==='dialog'">
      <el-dialog :title="popupTitle" :close-on-click-modal="false" :visible.sync="visible"
        v-if="visible" class="HONGAN4D-dialog HONGAN4D-dialog_center" lock-scroll append-to-body
        :width='popupWidth'>
        ...
        <HONGAN4D-table v-loading="listLoading" :data="list" :border="false" highlight-current-row
    ...
    <template v-if="popupType ==='drawer'">
      <el-drawer :title="popupTitle" :visible.sync="visible" :wrapperClosable="false" ref="drawer"
        :size='popupWidth' append-to-body class="HONGAN4D-common-drawer">
...
export default {
  ...
  methods: {
    ...
    interfaceDataHandler(data) {
      ...
      const dataHandler = this.hongan4d.getScriptFunc.call(this, data.dataProcessing)
...
>>> .el-dialog__body {
  ...
  .HONGAN4D-common-search-box {
    margin-bottom: 0;
    .HONGAN4D-common-search-box-right {
