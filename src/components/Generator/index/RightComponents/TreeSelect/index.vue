<template>
  <el-row>
    ...
    <el-form-item label="默认值">
      <HONGAN4D-TreeSelect :options="activeData.options" v-model="activeData.__config__.defaultValue"
    ...
    <template>
      ...
      <template v-if="activeData.__config__.dataType === 'dictionary'">
        <el-form-item label="远端数据">
          <HONGAN4D-TreeSelect :options="treeData" v-model="activeData.__config__.dictionaryType"
      ...
      <template v-if="activeData.__config__.dataType === 'dynamic'">
        <el-form-item label="远端数据">
          <HONGAN4D-TreeSelect :options="dataInterfaceSelector" v-model="activeData.__config__.propsUrl"
